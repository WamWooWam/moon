...
namespace System.Windows
{
    ...
    public sealed class VisualStateGroup : DependencyObject
    {
        ...
        {
            CurrentStateChanging?.Invoke(element, new VisualStateChangedEventArgs(oldState, newState, control));
        }
        ...
        {
            CurrentStateChanged?.Invoke(element, new VisualStateChangedEventArgs(oldState, newState, control));
        }
