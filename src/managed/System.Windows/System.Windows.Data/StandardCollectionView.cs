...
namespace System.Windows.Data
{
    ...
    sealed class ListCollectionView : EditableCollectionView, IComparer<object>
    {
        ...
        PropertyComparer Comparer => new PropertyComparer(SortDescriptions);
        ...
        bool IsValidSelection => CurrentPosition >= 0 && CurrentPosition < ActiveList.Count;
        ...
        public new IList SourceCollection => (IList)base.SourceCollection;
        ...
        void AddToSourceCollection(object item)
        {
            ...
            if (SourceCollection is not INotifyCollectionChanged)
            {
