...
namespace System.Windows.Controls
{
    ...
    [TemplatePart(Name = ElementTrackName, Type = typeof(FrameworkElement))]
    [TemplatePart(Name = ElementIndicatorName, Type = typeof(FrameworkElement))]
    ...
    public class ProgressBar : RangeBase
    {
        ...
        private void SetProgressBarIndicatorLength()
        {
            ...
            if (ElementTrack != null && ElementIndicator != null)
            {
                ...
                FrameworkElement parent = Media.VisualTreeHelper.GetParent(ElementIndicator) as FrameworkElement;
