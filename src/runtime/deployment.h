...
#if !INCLUDED_MONO_HEADERS && defined(MONO)
...
public:
	...
	/*ErrorEventArgs* ManagedExceptionToErrorEventArgs (void *exc);
	void ManagedExceptionToMoonError (void *exc, MoonError::ExceptionType type, MoonError *error);*/
