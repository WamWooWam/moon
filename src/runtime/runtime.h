...
#define VERIFY_MAIN_THREAD
    ...
    typedef void* (*MonoGCHandleNew)(void* handle, bool pinned);
    typedef void* (*MonoGCHandleNewWeakRef)(void *handle, bool track_resurrection);
    typedef void* (*MonoGCHandleGetTarget)(void *handle);
    typedef void (*MonoGCHandleFree)(void *handle);

    typedef void (*MoonEnsureManagedPeer)(void *depObj, Type::Kind kind);
    typedef bool (*MoonInitializeDeploymentXap)(void *plugin, const char *xapFile, const char *culture, const char *uiCulture);
    typedef bool (*MoonInitializeDeploymentXaml)(const char *culture, const char *uiCulture);
    typedef void (*MoonDestroyManagedApplication)(void *plugin);

    typedef void* (*MoonCreateXamlLoader)(void *nativeLoader, void *plugin, void *surface, void *resourceBase);
    typedef int (*MoonXamlParserCreateFromFile)(const char *file, bool create_namescope, bool validate_templates, Value **value);
    typedef int (*MoonXamlParserCreateFromText)(const char *text, bool create_namescope, bool validate_templates, Value **value);
    typedef int (*MoonXamlParserHydrateFromText)(const char *text, bool create_namescope, bool validate_templates, Value *object, Value **value);

    typedef bool (*MoonCanonicalizeFileName)(const char *fileName, bool is_xap_mode, char **result);
    typedef bool (*MoonCreateMediaLogXml)(const char **names, const char **values, char **result);
    typedef bool (*MoonCheckFileIntegrity)(const char *filename);
    
    typedef bool (*MonoRegisterICalls)(const void *func1, const void *func2);

    /* @Namespace=Mono */
    struct MOON_API RuntimeManagedCallbacks {
        MonoGCHandleNew mono_gchandle_new;
        MonoGCHandleNewWeakRef mono_gchandle_new_weakref;
        MonoGCHandleGetTarget mono_gchandle_get_target;
        MonoGCHandleFree mono_gchandle_free;

        MoonEnsureManagedPeer moon_ensure_managed_peer;
        MoonInitializeDeploymentXap moon_initialize_deployment_xap;
        MoonInitializeDeploymentXaml moon_initialize_deployment_xaml;
        MoonDestroyManagedApplication moon_destroy_managed_application;

        MoonCreateXamlLoader moon_create_xaml_loader;
        MoonXamlParserCreateFromFile moon_xaml_parser_create_from_file;
        MoonXamlParserCreateFromText moon_xaml_parser_create_from_text;
        MoonXamlParserHydrateFromText moon_xaml_parser_hydrate_from_text;

        MoonCanonicalizeFileName moon_canonicalize_file_name;
        MoonCreateMediaLogXml moon_create_media_log_xml;
        MoonCheckFileIntegrity moon_check_file_integrity;

        MonoRegisterICalls mono_register_icalls;
    };
    ...
    public:
        static RuntimeManagedCallbacks *callbacks;

        /* @GeneratePInvoke */
        static void InitializeCallbacks(RuntimeManagedCallbacks *callbacks);
