...
namespace Moonlight {
    ...
    struct Win32Font {
        ...
        Win32Font(FT_Face face, const char *path, int index) {
    ...
    MoonFontServiceWin32::MoonFontServiceWin32() {
        Win32Font *font;
        const char *name;
        GString *path;
        FT_Long i, n;
        ...
        while ((name = g_dir_read_name(dir))) {
            ...
            font = new Win32Font(face, path->str, 0);
    ...
    MoonFont *MoonFontServiceWin32::FindFont(const FontStyleInfo *desired) {
        Win32Font *font, *best = NULL;
        ...
        for (guint i = 0; i < system_fonts->len; i++) {
            font = (Win32Font *)system_fonts->pdata[i];
    ...
    void MoonFontServiceWin32::ForeachFont(MoonForeachFontCallback foreach, gpointer user_data) {
        Win32Font *font;
