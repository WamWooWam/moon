...
class MoonKeyEventWin32 : public MoonKeyEvent {
public:
    MoonKeyEventWin32(bool down, bool has_char, int32_t keycode, int32_t scancode, int32_t metastate, MoonModifier modifiers = (MoonModifier)0) {
        this->down = down;
    ...
    virtual ~MoonKeyEventWin32() {
    }

    virtual MoonEvent *Clone() {
        return new MoonKeyEventWin32(down, has_char, keycode, scancode, metastate, modifiers);
    }
