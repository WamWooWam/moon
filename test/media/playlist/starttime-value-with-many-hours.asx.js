var result = [
    "Opening: starttime-value-with-many-hours.asx", 
    "OnMediaOpened (MediaElement [starttime-value-with-many-hours.asx], RoutedEventArgs", 
    ...
    " Source: starttime-value-with-many-hours.asx", 
