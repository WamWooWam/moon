var result = [
    "Opening: starttime-with-invalid-value-time.asx", 
    "OnMediaOpened (MediaElement [starttime-with-invalid-value-time.asx], RoutedEventArgs", 
    ...
    " Source: starttime-with-invalid-value-time.asx", 
