var result = [
    "Opening: starttime-value-with-3-seconds.asx", 
    "OnMediaOpened (MediaElement [starttime-value-with-3-seconds.asx], RoutedEventArgs", 
    ...
    " Source: starttime-value-with-3-seconds.asx", 
