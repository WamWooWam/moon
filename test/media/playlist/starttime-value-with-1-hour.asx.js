var result = [
    "Opening: starttime-value-with-1-hour.asx", 
    "OnMediaOpened (MediaElement [starttime-value-with-1-hour.asx], RoutedEventArgs", 
    ...
    " Source: starttime-value-with-1-hour.asx", 
