var result = [
    "Opening: starttime-with-four-digit-fraction.asx", 
    "OnMediaOpened (MediaElement [starttime-with-four-digit-fraction.asx], RoutedEventArgs", 
    ...
    " Source: starttime-with-four-digit-fraction.asx", 
