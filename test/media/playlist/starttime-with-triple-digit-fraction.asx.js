var result = [
    "Opening: starttime-with-triple-digit-fraction.asx", 
    "OnMediaOpened (MediaElement [starttime-with-triple-digit-fraction.asx], RoutedEventArgs", 
    ...
    " Source: starttime-with-triple-digit-fraction.asx", 
