var result = [
    "Opening: starttime-value-with-9-seconds.asx", 
    "OnMediaOpened (MediaElement [starttime-value-with-9-seconds.asx], RoutedEventArgs", 
    ...
    " Source: starttime-value-with-9-seconds.asx", 
