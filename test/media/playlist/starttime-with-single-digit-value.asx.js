var result = [
    "Opening: starttime-with-single-digit-value.asx", 
    "OnMediaOpened (MediaElement [starttime-with-single-digit-value.asx], RoutedEventArgs", 
    ...
    " Source: starttime-with-single-digit-value.asx", 
