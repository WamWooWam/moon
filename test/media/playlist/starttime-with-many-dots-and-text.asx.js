var result = [
    "Opening: starttime-with-many-dots-and-text.asx", 
    "OnMediaOpened (MediaElement [starttime-with-many-dots-and-text.asx], RoutedEventArgs", 
    ...
    " Source: starttime-with-many-dots-and-text.asx", 
