var result = [
    "Opening: starttime-value-with-7.5-seconds.asx", 
    "OnMediaOpened (MediaElement [starttime-value-with-7.5-seconds.asx], RoutedEventArgs", 
    ...
    " Source: starttime-value-with-7.5-seconds.asx", 
