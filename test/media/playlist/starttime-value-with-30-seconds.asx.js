var result = [
    "Opening: starttime-value-with-30-seconds.asx", 
    "OnMediaOpened (MediaElement [starttime-value-with-30-seconds.asx], RoutedEventArgs", 
    ...
    " Source: starttime-value-with-30-seconds.asx", 
