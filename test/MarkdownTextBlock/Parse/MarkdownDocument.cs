            ...
            while (startOfLine < end)
            {
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        int _;
                        var currentEndOfLine = ParseHelpers.FindNextSingleNewLine(markdown, nonSpacePos, end, out _);
                ...
                int startOfNextLine;
                var endOfLine = ParseHelpers.FindNextSingleNewLine(markdown, nonSpacePos, end, out startOfNextLine);
