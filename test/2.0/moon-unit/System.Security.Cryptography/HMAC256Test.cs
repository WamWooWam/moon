...
// Copyright (C) 2006, 2007, 2009 Novell, Inc (http://www.novell.com)
//
...
namespace MoonTest.System.Security.Cryptography {
	...
	public class HMACSHA256Test {
		...
		public void CheckA (string testName, byte[] key, byte[] data, byte[] result) 
		{
			...
			AreEqual (result, hmac, testName + "a1");
			AreEqual (result, algo.Hash, testName + "a2");
		}
		...
		public void CheckB (string testName, byte[] key, byte[] data, byte[] result) 
		{
			...
			AreEqual (result, hmac, testName + "b1");
			AreEqual (result, algo.Hash, testName + "b2");
		}
		...
		public void CheckC (string testName, byte[] key, byte[] data, byte[] result) 
		{
			...
			AreEqual (result, hmac, testName + "c1");
			AreEqual (result, algo.Hash, testName + "c2");
		}
		...
		public void CheckD (string testName, byte[] key, byte[] data, byte[] result) 
		{
			...
			AreEqual (result, algo.Hash, testName + "d");
		}
		...
		{
			byte [] key = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20 };
			byte [] data = Encoding.UTF8.GetBytes ("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
		...
		{
			byte [] key = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f, 0x20 };
			byte [] data = Encoding.UTF8.GetBytes ("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopqabcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq");
		...
		public void HMACSHA256_TC8 () 
		{
			...
			byte [] data = Encoding.UTF8.GetBytes ("Test With Truncation");
		...
		public void HMACSHA256_TC10 () 
		{
			...
			for (int i = 0; i < key.Length; i++)
				key[i] = 0xaa;
			byte [] data = Encoding.UTF8.GetBytes ("Test Using Larger Than Block-Size Key and Larger Than One Block-Size Data");
